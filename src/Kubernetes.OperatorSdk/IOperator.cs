...
public interface IOperator : IDisposable
{
    ...
    IOperator AddController<TResource>(IController<TResource> controller, string watchNamespace = "default",
        string labelSelector = null) where TResource : CustomResource;
