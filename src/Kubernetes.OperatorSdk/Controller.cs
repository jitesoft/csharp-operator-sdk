...
public abstract class Controller<T> : IController<T> where T : CustomResource
{
    ...
    /// </summary>
    protected Task<T> UpdateStatusAsync<TResource>(TResource resource, string fieldManager = null,
        CancellationToken cancellationToken = default) where TResource : T, IStatus
    {
